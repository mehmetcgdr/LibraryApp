...
namespace BooksApp.Core
{
    public static class Jobs
    {
        ...
        public static string UploadImage(IFormFile image)
        {
            ...
            var randomName = $"{Guid.NewGuid()}{extension}"; //Guid yapısıyla resme random bir isim veriliyor.
            //Şimdi de resmi sunucuya yüklüyoruz
            var path = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot/images/books", randomName); //kayıt yeri
